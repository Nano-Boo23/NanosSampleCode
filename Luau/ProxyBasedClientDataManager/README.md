# What's this project?
A client sided module of my proxy-based data management modules for EoA, with the purpose of overhauling the previous architecture which used bindable / remote events and functions. <br>
